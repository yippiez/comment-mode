import { ensureFilesModeDirectoryVisible, getParentDirectoryPath } from "../controllers/state";
import { buildFileTreeRows, type FileTreeRow } from "../modes";
...
export class FileExplorer {
  ...
  public goToParentDirectory(): boolean {
    const parent = getParentDirectoryPath(this.directoryPath);
